...
class DaytimeCycleScheduleTests(unittest.TestCase):
    def test_slots_cover_weekday_hours_evening_cycle_and_two_reports(self) -> None:
        ...
        self.assertIn((8, 45), pairs)
        self.assertIn((15, 30), pairs)
        self.assertIn((15, 45), pairs)
        self.assertIn((16, 15), pairs)
        self.assertIn((17, 45), pairs)
        self.assertIn((22, 0), pairs)
        self.assertIn((23, 0), pairs)
        self.assertNotIn((7, 0), pairs)
        self.assertNotIn((7, 30), pairs)
        self.assertNotIn((8, 30), pairs)
        self.assertNotIn((16, 0), pairs)
        self.assertNotIn((18, 0), pairs)
    ...
    def test_next_slot_uses_1545_2200_and_2300(self) -> None:
        ...
        self.assertEqual(
            ...
            datetime(2026, 8, 18, 16, 15, tzinfo=MSK_TZ),
        )
        self.assertEqual(
